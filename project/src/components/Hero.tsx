...
const Hero = () => {
  return (
    <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-marble-pattern bg-cover bg-center bg-fixed"></div>
      ...
      <div className="relative z-20 text-center px-4 sm:px-6 max-w-5xl mx-auto">
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-4 text-gray-900 drop-shadow-sm">
          ...
          <span className="block text-3xl sm:text-4xl mt-2 text-primary">Marcoussis</span>
        </h1>
        
        <p className="text-xl sm:text-2xl mb-8 text-gray-800">
          Livraison gratuite à domicile et au bureau - <span className="text-green-600">Halal</span>
        </p>
