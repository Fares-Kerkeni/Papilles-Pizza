    ...
    <section id="about" className="section-container">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="menu-card flex flex-col items-center">
          ...
          <ul className="space-y-2 text-center">
            ...
            <li>
              ...
              <p className="text-gray-300">Soir uniquement</p>
            </li>
          </ul>
        </div>
        ...
        <div className="menu-card flex flex-col items-center">
          ...
          <h3 className="text-xl font-bold mb-4 text-center">Paiements Acceptés</h3>
          <div className="space-y-2 text-center">
            <p>Carte Bancaire</p>
            <p>Tickets Restaurant</p>
            <p className="text-yellow-500 font-medium mt-4">Minimum de commande: 15€</p>
          </div>
        </div>
      </div>
      
      <div className="mt-16 menu-card">
        <h3 className="text-2xl font-bold mb-6 text-center text-yellow-500">Livraison Gratuite</h3>
        <p className="text-center text-lg">
          Profitez de notre livraison gratuite à domicile et au bureau dans Marcoussis et ses environs.
        </p>
